...
#ifndef _MOLA_ACTOR_H_
#define _MOLA_ACTOR_H_
...
class Actor : public WorkItem {
  friend class Module;

protected:
  Actor(ActorID id, Module *module)
    : WorkItem(id), m_module(module)
    , m_status(ACTOR_STARTUP)
    , m_data_ptr(nullptr)
    , m_reqid_generator(0)
